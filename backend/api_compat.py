...
def _get_redis_client():
    try:
        REDIS_HOST = os.getenv("UNIOSS_REDIS_HOST", os.getenv("REDIS_HOST", "localhost"))
        REDIS_PORT = int(os.getenv("UNIOSS_REDIS_PORT", os.getenv("REDIS_PORT", "6379")))
        REDIS_DB = int(os.getenv("UNIOSS_REDIS_DB", "0"))
